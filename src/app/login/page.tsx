    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary-container relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 text-center px-xl">
          ...
          <p className="font-body-lg text-body-lg text-on-primary-container mt-md max-w-md">
            Sistema inteligente de gestión de inventario para farmacias.
            Controla stock, lotes, ventas y más desde un solo lugar.
          </p>

          <div className="flex flex-col gap-md mt-xl max-w-xs mx-auto">
      ...
      <div className="flex-1 flex items-center justify-center bg-surface p-lg">
          ...
          <div className="bg-surface-container-lowest p-xl rounded-2xl border border-outline-variant shadow-sm">
            ...
            {error && (
              <div className="mb-md p-sm bg-error-container text-on-error-container rounded-lg font-body-md text-body-md flex items-center gap-sm">
                ...
                <span>{error === "Invalid login credentials" ? "Credenciales inválidas. Verifica tu email y contraseña." : error}</span>
              </div>
            )}
            ...
            <form action={login} className="space-y-lg">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    autoComplete="email"
                    className="w-full bg-surface-container-low border border-outline-variant rounded-lg pl-xl pr-md py-sm font-body-md text-body-md focus:ring-2 focus:ring-secondary/20 outline-none transition-all placeholder:text-on-surface-variant/50"
              ...
              <button
                type="submit"
                className="w-full bg-secondary text-on-secondary font-bold py-sm rounded-lg hover:brightness-110 active:scale-95 transition-all shadow-sm shadow-secondary/30 flex items-center justify-center gap-sm"
              >
