  ...
  return (
    <>
            ...
            <tbody className="divide-y divide-outline-variant/30">
              {movimientos.map((m) => (
                <tr key={m.id} className="hover:bg-surface-container-low transition-colors">
                  ...
                  <td className="px-md py-sm font-body-md text-body-md font-bold text-on-surface">
                    {m.cantidad}
                  </td>
              ...
              {movimientos.length === 0 && (
                <tr>
                  <td colSpan={7} className="text-center py-xl text-on-surface-variant font-body-md">
                    No hay movimientos registrados. Crea el primero usando los botones de arriba.
                  </td>
                </tr>
              )}
            </tbody>
      ...
      <Modal
        ...
        size="md"
      >
        <form action={registrarMovimiento} className="space-y-md">
