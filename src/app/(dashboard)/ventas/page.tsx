...
export default function VentasPage() {
  ...
  const handleRegistrar = async () => {
    ...
    try {
      ...
      if (userError || !user) {
        alert("Error de autenticación: " + (userError?.message || "No hay sesión"))
        return
      }
      ...
      if (errorVenta) {
        ...
        alert("Error: " + errorVenta.message)
        return
      }
      ...
      if (errorDetalle) {
        ...
        alert("Error detalle: " + errorDetalle.message)
        return
      }
    ...
    <div style={{ display: "flex", gap: "24px", height: "calc(100vh - 120px)" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        <div className="relative">
          ...
          <input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Buscar producto por nombre o código..."
